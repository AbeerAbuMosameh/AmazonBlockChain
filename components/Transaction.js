...
const Transaction = ({ item }) => {
  const styles = {
    ...
    SellingBtn: `bg-[#ffd713] font-bold rounded-full p-[10px] h-[40px] w-[200px] cursor-pointer text-[#3a2802] text-center mb-[5px] mt-[10px]`,
              ...
              <div className={styles.item}>
                ...
                <div className={styles.nameContainer}>
                  ...
                  <div className='flex flex-row items-center justify-center gap-4'>
                    <div className={styles.SellingBtn}>Selling it</div>
